...
{
    public partial class TC_ChiTien : Form
    {
        bool fl_new = true;
        DataTable dtBC;
        public TC_ChiTien()
        ...
        private void TC_PhieuChi_Load(object sender, EventArgs e)
        {
            ...
            Common.obj.Add_NewCommand("Select Code = MaTC, Name = TenTC from TC_MaTC where LoaiTC = 'Chi'", sys_ConData.sys_ConData.cmdType.Query);
        ...
        private void btn_Del_Click(object sender, EventArgs e)
        {
            ...
            DialogResult dr = MessageBox.Show("Bạn có chắc chắn muốn xóa Phiếu chi này?", "Thông báo", MessageBoxButtons.YesNo);
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            if(cbo_MaKH.aaValueCode.ToString() != "" & txt_TongTien.Text != "0")
            {
                if (fl_new == true)
                {
                    ...
                    Common.obj.Add_MyParametersCommand("@LoaiTC", SqlDbType.NVarChar, "Chi");
                    Common.obj.ExecCommand_NoReturn(Common.obj.Get_NewCommand());
        ...
        private void GetData_BC()
        {
            ...
            Common.obj.Add_MyParametersCommand("@Type", SqlDbType.NVarChar, "Chi");
