...
{
    public partial class BC_CongNoPhaiThu : Form
    {
        DataTable dtBC;
        public BC_CongNoPhaiThu()
        {
            InitializeComponent();
        }

        private void BC_CongNoPhaiThu_Load(object sender, EventArgs e)
        {
        ...
        private void GetData_BC()
        {
            ...
            Common.obj.Add_MyParametersCommand("@Type", SqlDbType.NVarChar, "PhaiThu");
            ...
            try
            {
                ...
                g_BC.Cols[1].Caption = "Mã KH";
                g_BC.Cols[1].Width = 100;
                g_BC.Cols[1].Visible = true;
                g_BC.Cols[2].Caption = "Tên Khách";
