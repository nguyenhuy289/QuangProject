...
{
    public partial class BC_ChiTietHangTheoChuongTrinh : Form
    {
        DataTable dtBC;
        public BC_ChiTietHangTheoChuongTrinh()
        {
            InitializeComponent();
        }

        private void BC_ChiTietHangTheoChuongTrinh_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void GetData_BC()
        {
            ...
            Common.obj.Add_MyParametersCommand("@Type", SqlDbType.NVarChar, "TheoChuongTrinh");
