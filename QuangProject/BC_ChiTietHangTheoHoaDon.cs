...
{
    public partial class BC_ChiTietHangTheoHoaDon : Form
    {
        DataTable dtBC;
        public BC_ChiTietHangTheoHoaDon()
        {
            InitializeComponent();
        }

        private void BC_ChiTietHangTheoHoaDon_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void GetData_BC()
        {
            ...
            Common.obj.Add_MyParametersCommand("@Type", SqlDbType.NVarChar, "TheoHoaDon");
            ...
            try
            {
                ...
                if (g_BC.Rows.Count > 1)
                {
                    ...
                    g_BC.Subtotal(AggregateEnum.Sum, 1, 1, index, "{0}");
                    g_BC.Subtotal(AggregateEnum.Sum, 1, 1, index1, "{0}");
